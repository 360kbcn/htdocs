    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="modificar.php">Editar</a></li>
      ...
      <ul>
        ...
        /*******************************************************/
            ...
            foreach ($datos as $value) {
              ...
              echo "<li><a href='?id={$value['id']}'>{$value['titulo']}</a></li>";
            }
      ...
      <fieldset>
        ...
        <form class="form-horizontal" method="POST" action="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-11">
              <input type="hidden" class="form-control" name="genero" id="gen" value="<?php if($serieEditar!=null) echo $serieEditar['genero']; ?>" required>
            </div>
          </div>
          <div class="form-group">
