...
if(!$res){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Base de datos creada correctamente.</p>";
}
...
if($con===false){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Conexión con BD pinkladyseries establecida.</p>";
}
...
if($res===false){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Tabla genero creada correctamente.</p>";
}
...
if($res===false){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Tabla series creada correctamente.</p>";
}
...
if($res===false){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Datos series insertados correctamente</p>";
}
...
if($res===false){
  ...
  echo "<p class='text-danger'>".$con->errorInfo()[2]."</p>";
    ...
    echo "<p class='text-success'>Usuario insertado correctamente</p>";
}
