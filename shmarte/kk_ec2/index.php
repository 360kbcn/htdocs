...
<html>
  ...
  <body background="fondo360.png"><!--Fondo para la aplicacion -->
    ...
    <h2 id="h2"><strong>Nuevo Contacto</strong></h2>
    <br>
    <form action="" method="post">
    <p id="letra"><strong>Introduce un Nombre </strong></p><input type="text" name="New_Contact" value="">
    <p id="letra"><strong>Introduce un Email</strong></p><input type="text" name="New_Email" value="">
    <br>
    <br>
    <input id="Btn" type="submit" name="Alta" value="Alta Nueva">
    <br>
    <br>
  </form>
    </div>
