...
<div class="container">
  ...
  <p class="lead">Rellena los campos con la información necesaria. </p>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
            ...
            <input type="text" class="form-control" name="titulo_url" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
    <label for="exampleSelect1">ID Categoría:</label><br>
    ...
    <textarea class="form-control" name="sinopsis" id="Textarea" rows="3"></textarea>
    </div>
