...
<div class="container">
  ...
  <p class="lead">Los cambios realizados no se pueden rehacer. </p>


<?php
tablaEliminarCartelera();
if (isset($eliminaarticulo) && $eliminaarticulo== false){
  echo '<span>
  <button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <p class="bg-success">La categoria'.$eliminaarticulo['nombre'].' ha sido eliminada </p>
  </span>';

}elseif(isset($eliminaarticulo) && $eliminaarticulo==true){
  echo '<span>
  <button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button>
