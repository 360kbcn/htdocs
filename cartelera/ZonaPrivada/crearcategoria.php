...
<div class="container">
  ...
  <p class="lead">Rellena el campo con la información necesaria. </p>
  ...
  <form action="" method="post">
    ...
    <div class="form-group">
            ...
            <input type="name" class="form-control" name="nombre_url" required>
    </div>
...
<?php
    require ("funciones.php");
     if (isset($_POST['nombre']) && $_POST['nombre_url']!='') {
       $nombre = $_POST['nombre'];
       $n_url = $_POST['nombre_url'];

       addCategoria($nombre, $n_url);
     }
