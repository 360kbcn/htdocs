...
<html lang="es">
  ...
  <body background="fondo360.png">
    ...
    try {
     ...
     $val->exec("DROP database contactos;");
      ...
      echo "<br>";
       ...
       echo "<br>";
        ...
        $sqlcontact="create database acceso;";
        ...
        if($resul==false){
          ...
          echo "<p id='Bien'>Base de datos accesos creada con exito.</p>";
          echo"<br>";
        }

        // Conectamos con la bases de datos
        $sqlcontact ="use acceso;";
        $resul=$val->exec($sqlcontact);
        if(!$resul==false){
        ...
        $sqlcontact="create table usereg(id integer primary key auto_increment, nombre varchar(30) not null, contrasena varchar(50) unique);";
        $resul=$val->exec($sqlcontact);
        if($resul===false){
